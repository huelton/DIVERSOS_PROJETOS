 create tablespace erp_mult_tst
         datafile
         '/home/oracle/app/oracle/oradata/orcl/erp_mult_tst.dbf' 
...
alter user user_tst quota unlimited on erp_mult_tst;
 ...
 create tablespace erp_mult_prd
         datafile
         '/home/oracle/app/oracle/oradata/orcl/erp_mult_prd.dbf' 
		size 100m autoextend on next 50m maxsize 500m
         online
         permanent
         extent management local autoallocate
...
CREATE TABLE FOLHA_PAGTO
    ...
    COD_EMPRESA INT NOT NULL,
	MATRICULA INT NOT NULL,
	TIPO_PGTO CHAR(1) NOT NULL,-- (M-FOLHA,A-ADTO,F-FERIAS,D-13 DECIMO TERCEIRO,R-RESC),
...
--CRIACAO TABELA CONDICOES DE PAGTO
