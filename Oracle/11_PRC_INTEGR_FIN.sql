...
CREATE OR REPLACE PROCEDURE PRC_INTEGR_FIN

IS 
  
  V_EXC_SEM_DOCTO EXCEPTION;

  BEGIN

     --ABRINDO PRIMEIRO IF
     FOR C_CONTA IN (SELECT COUNT(*) QTD
                       FROM NOTA_FISCAL 
                      WHERE INTEGRADA_FIN = 'N') LOOP

        IF C_CONTA.QTD = 0 THEN

           RAISE V_EXC_SEM_DOCTO;
        END IF;
     ...
     END LOOP;
      ...
      FOR C_FIN IN (SELECT A.COD_EMPRESA, A.TIP_NF, A.NUM_NF, 
      	                   B.PARC, A.ID_CLIFOR,A.COD_PAGTO,
               ...
               IF C_FIN.TIP_NF = 'S' THEN
                    ...
                    INSERT INTO CONTAS_RECEBER (COD_EMPRESA, ID_DOC, ID_CLIENTE, ID_DOC_ORIG, PARC, DATA_VENC, VALOR)  
                           VALUES (C_FIN.COD_EMPRESA, NULL, C_FIN.ID_CLIFOR, C_FIN.NUM_NF, 
                           	       C_FIN.PARC, C_FIN.VENCIMENTO, C_FIN.VALOR_PARC);
