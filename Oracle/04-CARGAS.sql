...
--select * from CIDADES
INSERT INTO CIDADES
SELECT distinct x.cod_mun,x.cod_uf,x.nome_mun  FROM hr.SENSO x;
...
INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9001','JAMES LABRIE','1234567','123567990','RUA 1','2','SANTA CLAUS','3525904',to_date('10/03/2017','dd/mm/yyyy'),'',to_date('25/12/1980','dd/mm/yyyy'),'111111',1);

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9002','JONH LARAVEL','1234568','123567889','RUA 2','3','SANTA CLAUS','3525904',to_date('10/02/2017','dd/mm/yyyy'),'',to_date('12/01/1990','dd/mm/yyyy'),'121212','4');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9003','PETER DOTNESK','3434568','123564578','RUA 3','4','SANTA CLAUS','3525904',to_date('09/02/2017','dd/mm/yyyy'),'',to_date('04/06/1988','dd/mm/yyyy'),'12121121','6');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9004','LARA POTTER','4434509','123576867','RUA 4','5','SANTA CLAUS','3525904',to_date('07/03/2017','dd/mm/yyyy'),'',to_date('25/10/1990','dd/mm/yyyy'),'65841','7');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9005','JESSICA SUTER','4534576','120367887','RUA 5','6','SANTA CLAUS','3525904',to_date('03/03/2017','dd/mm/yyyy'),'',to_date('09/03/1983','dd/mm/yyyy'),'12154','5');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9006','PEDRO TESLA','4334568','123703885','RUA 6','7','SANTA CLAUS','3525904',to_date('15/04/2017','dd/mm/yyyy'),'',to_date('25/10/1987','dd/mm/yyyy'),'56477','1');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9007','TIAGO FIELDER','9834568','147034889','RUA 7','8','SANTA CLAUS','3525904',to_date('20/04/2015','dd/mm/yyyy'),'',to_date('10/03/1982','dd/mm/yyyy'),'985124','2');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9007','MALCON DEXTER','9834568','147067889','RUA 17','28','SANTA CLAUS','3525904',to_date('20/04/2015','dd/mm/yyyy'),'',to_date('05/05/1987','dd/mm/yyyy'),'85445','3');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9007','CHARLES NOIX','9894668','147067149','RUA 77','18','SANTA CLAUS','3525904',to_date('20/04/2017','dd/mm/yyyy'),'',to_date('06/10/1979','dd/mm/yyyy'),'654789','3');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9008','JOAO SPARK','7734568','643567888','RUA 8','22','SANTA CLAUS','3525904',to_date('20/04/2017','dd/mm/yyyy'),'',to_date('26/01/1984','dd/mm/yyyy'),'32564','9');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9009','DAVID MANDRAKE','6634568','345567887','RUA 8','56','SANTA CLAUS','3525904',to_date('05/07/2016','dd/mm/yyyy'),'',to_date('10/10/1980','dd/mm/yyyy'),'147852','8');

INSERT INTO FUNCIONARIO VALUES
 (1,NULL,'9002','SAMUEL DUPRET','8984568','159567887','RUA 23','89','SANTA CLAUS','3525904',to_date('05/07/2016','dd/mm/yyyy'),'',to_date('26/10/1988','dd/mm/yyyy'),'987452','10');
...
--CRIANDO FUNCAO PARA CRIPTOGRAFAR
 --criando funcao para gerar senha
...
--DELETE FROM PED_VENDAS
 ...
 (1,1,1,TO_DATE('13/01/2018','DD/MM/YYYY'),TO_DATE('29/01/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,3,TO_DATE('13/02/2018','DD/MM/YYYY'),TO_DATE('28/02/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (2,3,2,TO_DATE('13/03/2018','DD/MM/YYYY'),TO_DATE('29/03/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,2,TO_DATE('13/04/2018','DD/MM/YYYY'),TO_DATE('29/04/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,3,TO_DATE('13/05/2018','DD/MM/YYYY'),TO_DATE('29/05/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,1,3,TO_DATE('13/06/2018','DD/MM/YYYY'),TO_DATE('29/06/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,1,TO_DATE('13/07/2018','DD/MM/YYYY'),TO_DATE('29/07/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (2,3,3,TO_DATE('13/08/2018','DD/MM/YYYY'),TO_DATE('29/08/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (2,3,2,TO_DATE('13/09/2018','DD/MM/YYYY'),TO_DATE('29/09/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,2,1,TO_DATE('13/10/2018','DD/MM/YYYY'),TO_DATE('29/10/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (1,1,2,TO_DATE('13/11/2018','DD/MM/YYYY'),TO_DATE('29/11/2018','DD/MM/YYYY'),'A');
 INSERT INTO PED_VENDAS (COD_EMPRESA,ID_CLIENTE,COD_PAGTO,DATA_PEDIDO,DATA_ENTREGA,SITUACAO) VALUES
 (2,3,2,TO_DATE('13/12/2018','DD/MM/YYYY'),TO_DATE('29/12/2019','DD/MM/YYYY'),'A');
...
--SELECT * FROM PARAM_INSS
   INSERT INTO PARAM_INSS VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/2018','DD/MM/YYYY'),0,1659.38,8);
   INSERT INTO PARAM_INSS VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/2018','DD/MM/YYYY'),1659.39,2765.66,9);
   INSERT INTO PARAM_INSS VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/2018','DD/MM/YYYY'),2765.67,5531.31,11);
   INSERT INTO PARAM_INSS VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/2018','DD/MM/YYYY'),5531.32,999999,0);

--CARGA PARAMETROS IRPF

--SELECT * FROM PARAM_IRRF
 INSERT INTO PARAM_IRRF VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/2018','DD/MM/YYYY'),0,1903.98,0,0);
 INSERT INTO PARAM_IRRF VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/2018','DD/MM/YYYY'),1903.99,2826.65,7.5,142.80);
 INSERT INTO PARAM_IRRF VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/201','DD/MM/YYYY'),2826.66,3751.05,15,354.80);
 INSERT INTO PARAM_IRRF VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/2018','DD/MM/YYYY'),3751.06,4664.68,22.5,636.13);
 INSERT INTO PARAM_IRRF VALUES (TO_DATE('01/01/2018','DD/MM/YYYY'),TO_DATE('31/12/2018','DD/MM/YYYY'),4664.68,999999,27.5,869.36);
