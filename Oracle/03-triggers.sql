...
-- SEQUENCIA PARA TABELA APONTAMENTO      
...
-- SEQUENCIA PARA TABELA CONTAS A PAGAR        
...
-- SEQUENCIA PARA TABELA CLIENTES
...
-- SEQUENCIA PARA TABELA CONTAS RECEBER
...
-- SEQUENCIA PARA TABELA FORNECEDOR
...
-- SEQUENCIA PARA TABELA ORDEM DE PRODUCAO
-- SEQ_OP       CAMPO ID_ORDER
...
-- SEQUENCIA PARA TABELA CONDICAO DE PAGAMENTO
...
-- SEQUENCIA PARA TABELA TIPO DE MATERIAL
...
-- SEQUENCIA PARA TABELA VENDEDORES
...
CREATE OR REPLACE TRIGGER TRG_NUM_NFE
   ...
   FOR EACH ROW
       BEGIN
          UPDATE PARAM_NFE SET NUM_NFE=NUM_NFE+1 
           WHERE COD_EMPRESA=:NEW.COD_EMPRESA;
          SELECT NUM_NFE INTO :NEW.NUM_NF FROM PARAM_NFE 
           WHERE COD_EMPRESA=:NEW.COD_EMPRESA;
       END;  
...
CREATE OR REPLACE TRIGGER TRG_NUM_PED_COMPRAS
   ...
   FOR EACH ROW
       BEGIN
          UPDATE PARAM_PED_COMPRAS SET NUM_PED=NUM_PED+1 
           WHERE COD_EMPRESA=:NEW.COD_EMPRESA;
          SELECT NUM_PED INTO :NEW.NUM_PEDIDO FROM PARAM_PED_COMPRAS 
           WHERE COD_EMPRESA=:NEW.COD_EMPRESA;
       END;
...
CREATE OR REPLACE TRIGGER TRG_NUM_PED_VENDAS
   ...
   FOR EACH ROW
       BEGIN
          UPDATE PARAM_PED_VENDAS SET NUM_PED=NUM_PED+1
           WHERE COD_EMPRESA=:NEW.COD_EMPRESA;
          SELECT NUM_PED INTO :NEW.NUM_PEDIDO FROM PARAM_PED_VENDAS
           WHERE COD_EMPRESA=:NEW.COD_EMPRESA;
       END;        
...
CREATE OR REPLACE TRIGGER TRG_MAT_FUNC
   ...
   FOR EACH ROW
       BEGIN
          UPDATE PARAM_MATRICULA SET MATRICULA=MATRICULA+1 
           WHERE COD_EMPRESA=:NEW.COD_EMPRESA;
          SELECT MATRICULA INTO :NEW.MATRICULA FROM PARAM_MATRICULA
           WHERE COD_EMPRESA=:NEW.COD_EMPRESA;
       END;